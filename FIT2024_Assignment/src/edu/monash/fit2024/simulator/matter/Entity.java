...
/**
 * Base class for simulated items and actors.
 * 
...
public abstract class Entity implements EntityInterface {
	...
	/**
	 * <p>Set of Affordances representing actions that can be performed on this Entity.</p>
	 * 
	...
	/**
	 *  <p>The default constructor is private to enforce the setting of a MessageRenderer in 
	 *  descendant classes.  Subclasses should explicitly call the parameterized version of
	 *  the constructor that takes a MessageRenderer.</p>
	 */
	@SuppressWarnings("unused")
	private Entity() {};
	
	/**
	 * <p>Parameterized constructor that sets a MessageRenderer.</p>
	 * 
	 * @param m output device to allow the Entity to display messages
	 */
